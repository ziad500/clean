...
extension ServiceResponseMapper on ServiceResponse? {
  Service toDomain() {
    return Service(this?.id ?? Constants.empty, this?.title ?? Constants.empty,
...
extension BannersResponseMapper on BannersResponse? {
  Banners toDomain() {
    return Banners(this?.id ?? Constants.empty, this?.link ?? Constants.empty,
...
extension StoreResponseMapper on StoreResponse? {
  Stores toDomain() {
    return Stores(this?.id ?? Constants.empty, this?.title ?? Constants.empty,
        this?.image ?? Constants.empty);
  }
}
