  ...
  Failure getFailure() {
    switch (this) {
      ...
      case DataSource.SEND_TIME_OUT:
        return Failure(
            ResponseCode.SEND_TIME_OUT, ResponseMessage.SEND_TIMEOUT.tr());

      case DataSource.CASHE_ERROR:
        return Failure(
            ResponseCode.CASHE_ERROR, ResponseMessage.CACHE_ERROR.tr());
...
class ResponseMessage {
  ...
  static const String NOT_FOUND =
      AppStrings.notFoundError; // failure, Not Found
